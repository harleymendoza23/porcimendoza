...
<body style="background:#BDC3C7 fixed no-repeat 0 0 ;">
  ...
  <div class="container-fluid">
    ...
    <div class="col col-xl-2 col-md-6 col-12">
        <div style=" position: -webkit-sticky;position: sticky;top: 15px; background-color: #AED6F1; border: solid; ">
          <!-- position: -webkit-sticky;position: sticky;  sirve para dejar algo que siempre se vea-->

          <label for="">Organizar por precios:</label>
          <div class="col col-xl-3 col-md-6 col-12">
            <input type="text" style="height: auto; width: 100px;" placeholder="Precio menor" name="producto_menor" id="separador">
            <label for=""></label>
            <input type="text" style="height: auto; width: 100px;" placeholder="Precio mayor" name="producto_mayor" id="separadormayor">
